...
namespace WaveFront
{
	...
	public:
		...
		Microsoft::WRL::ComPtr<ID3D11Texture2D> CreateTexture2D(const uint3& a_ResDepth, DXGI_FORMAT a_Format = DXGI_FORMAT_R16G16B16A16_FLOAT, unsigned int a_BindFlag = 0);
