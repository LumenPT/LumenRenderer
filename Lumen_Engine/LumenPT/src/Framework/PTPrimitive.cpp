...
PTPrimitive::PTPrimitive(std::unique_ptr<MemoryBuffer> a_VertexBuffer, std::unique_ptr<MemoryBuffer> a_IndexBuffer, std::unique_ptr<AccelerationStructure> a_GeometryAccelerationStructure)
