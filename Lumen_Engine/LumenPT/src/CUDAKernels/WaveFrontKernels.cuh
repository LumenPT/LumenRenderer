...
CPU_GPU void ShadeDirect(const uint3& a_ResolutionAndDepth, const IntersectionBuffer* const a_Intersections, const RayBatch* const a_CurrentRays, ShadowRayBatch* const a_ShadowRays, const LightBuffer* const a_Lights);
