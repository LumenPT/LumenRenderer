...
* \returns nv_bfloat16
* \retval \p a converted to nv_bfloat16.
* \internal
...
* 
* \details Convert the nv_bfloat16-precision floating point value \p h to a signed integer in
...
* 
* \details Convert the signed integer value \p i to a nv_bfloat16-precision floating point
* value in round-to-nearest-even mode.
* \param[in] i - int. Is only being read. 
* 
* \returns nv_bfloat16
* \retval \p i converted to nv_bfloat16. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* mode.
* 
* \details Convert the nv_bfloat16-precision floating point value \p h to a signed short
...
* mode.
* 
* \details Convert the signed short integer value \p i to a nv_bfloat16-precision floating
...
* 
* \details Convert the nv_bfloat16-precision floating point value \p h to an unsigned integer
...
* 
* \details Convert the unsigned integer value \p i to a nv_bfloat16-precision floating point
* value in round-to-nearest-even mode.
...
* mode.
* 
* \details Convert the nv_bfloat16-precision floating point value \p h to an unsigned short
* integer in round-to-nearest-even mode.
* \param[in] h - nv_bfloat16. Is only being read. 
* 
...
* mode.
* 
* \details Convert the unsigned short integer value \p i to a nv_bfloat16-precision floating
* point value in round-to-nearest-even mode.
...
* mode.
* 
* \details Convert the nv_bfloat16-precision floating point value \p h to an unsigned 64-bit
* integer in round-to-nearest-even mode.
* \param[in] h - nv_bfloat16. Is only being read. 
* 
...
* mode.
* 
* \details Convert the unsigned 64-bit integer value \p i to a nv_bfloat16-precision floating
* point value in round-to-nearest-even mode.
...
* mode.
* 
* \details Convert the nv_bfloat16-precision floating point value \p h to a signed 64-bit
* integer in round-to-nearest-even mode.
* \param[in] h - nv_bfloat16. Is only being read. 
* 
...
* mode.
* 
* \details Convert the signed 64-bit integer value \p i to a nv_bfloat16-precision floating
* point value in round-to-nearest-even mode.
...
/**
* \ingroup CUDA_MATH__BFLOAT16_FUNCTIONS
* \brief Round input to nearest integer value in nv_bfloat16-precision floating point
* number.
* 
* \details Round \p h to the nearest integer value in nv_bfloat16-precision floating point
...
* 
* \details Reinterprets the bits in the nv_bfloat16-precision floating point number \p h
...
* 
* \details Reinterprets the bits in the nv_bfloat16-precision floating point \p h
...
* nv_bfloat16-precision floating point number.
* \param[in] i - short int. Is only being read. 
* 
* \returns nv_bfloat16
* \retval The reinterpreted value.
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_sync(unsigned mask, __nv_bfloat162 var, int delta, int width = warpSize);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_up_sync(unsigned mask, __nv_bfloat162 var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_down_sync(unsigned mask, __nv_bfloat162 var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_xor_sync(unsigned mask, __nv_bfloat162 var, int delta, int width = warpSize);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
* \brief Exchange a variable between threads within a warp. Direct copy from indexed thread. 
* 
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_sync(unsigned mask, __nv_bfloat16 var, int delta, int width = warpSize);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
* \brief Exchange a variable between threads within a warp. Copy from a thread with lower ID relative to the caller. 
* \details Calculates a source thread ID by subtracting delta from the caller's lane ID. 
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_up_sync(unsigned mask, __nv_bfloat16 var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
* \brief Exchange a variable between threads within a warp. Copy from a thread with higher ID relative to the caller. 
* 
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_down_sync(unsigned mask, __nv_bfloat16 var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
* \brief Exchange a variable between threads within a warp. Copy from a thread based on bitwise XOR of own thread ID. 
* 
...
* \endinternal
*/
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_xor_sync(unsigned mask, __nv_bfloat16 var, int delta, int width = warpSize);
