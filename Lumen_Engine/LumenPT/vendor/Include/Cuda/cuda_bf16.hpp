...
__device__ __forceinline__ __nv_bfloat16 &operator--(__nv_bfloat16 &h)      { __nv_bfloat16_raw one; one.x = 0x3F80; h -= one; return h; }
__device__ __forceinline__ __nv_bfloat16  operator++(__nv_bfloat16 &h, int) { __nv_bfloat16 ret = h; __nv_bfloat16_raw one; one.x = 0x3F80; h += one; return ret; }
__device__ __forceinline__ __nv_bfloat16  operator--(__nv_bfloat16 &h, int) { __nv_bfloat16 ret = h; __nv_bfloat16_raw one; one.x = 0x3F80; h -= one; return ret; }
...
__device__ __forceinline__ __nv_bfloat162  operator++(__nv_bfloat162 &h, int) { __nv_bfloat162 ret = h; __nv_bfloat162_raw one; one.x = 0x3F80; one.y = 0x3F80; h = __hadd2(h, one); return ret; }
__device__ __forceinline__ __nv_bfloat162  operator--(__nv_bfloat162 &h, int) { __nv_bfloat162 ret = h; __nv_bfloat162_raw one; one.x = 0x3F80; one.y = 0x3F80; h = __hsub2(h, one); return ret; }
...
__VECTOR_FUNCTIONS_DECL__ __nv_bfloat162 make_bfloat162(__nv_bfloat16 x, __nv_bfloat16 y)
{
...
__CUDA_HOSTDEVICE_BF16_DECL__ __nv_bfloat162 __float22bfloat162_rn(const float2 f)
{
    __nv_bfloat162 val = __floats2bfloat162_rn(f.x, f.y);
    return val;
}
__CUDA_HOSTDEVICE_BF16_DECL__ float2 __bfloat1622float2(const __nv_bfloat162 l)
{
    float hi_float;
    float lo_float;
    lo_float = __internal_bfloat162float(((__nv_bfloat162_raw)l).x);
    hi_float = __internal_bfloat162float(((__nv_bfloat162_raw)l).y);
    return make_float2(lo_float, hi_float);
}
__CUDA_BF16_DECL__ int __bfloat162int_rn(__nv_bfloat16 h)
{
    return __float2int_rn(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ int __bfloat162int_rz(__nv_bfloat16 h)
{
...
__CUDA_BF16_DECL__ int __bfloat162int_rd(__nv_bfloat16 h)
{
    return __float2int_rd(__bfloat162float(h));
}
__CUDA_BF16_DECL__ int __bfloat162int_ru(__nv_bfloat16 h)
{
    return __float2int_ru(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ __nv_bfloat16 __int2bfloat16_rn(int i)
{
#if (defined __CUDA_ARCH__)
    float ru = __int2float_ru(i);
    float rd = __int2float_rd(i);
...
__CUDA_BF16_DECL__ __nv_bfloat16 __int2bfloat16_rz(int i)
{
    return __float2bfloat16_rz(__int2float_rz(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __int2bfloat16_rd(int i)
{
    return __float2bfloat16_rd(__int2float_rd(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __int2bfloat16_ru(int i)
{
    return __float2bfloat16_ru(__int2float_ru(i));
}

__CUDA_BF16_DECL__ short int __bfloat162short_rn(__nv_bfloat16 h)
{
   short int val;
   asm("{ .reg.f32 f;\n"
       "  mov.b32 f, {0,%1};\n"
...
__CUDA_HOSTDEVICE_BF16_DECL__ short int __bfloat162short_rz(__nv_bfloat16 h)
{
   short int val;
#if (defined __CUDA_ARCH__)
   asm("{ .reg.f32 f;\n"
...
__CUDA_BF16_DECL__ short int __bfloat162short_rd(__nv_bfloat16 h)
{
   short int val;
   asm("{ .reg.f32 f;\n"
       "  mov.b32 f, {0,%1};\n"
...
__CUDA_BF16_DECL__ short int __bfloat162short_ru(__nv_bfloat16 h)
{
   short int val;
   asm("{ .reg.f32 f;\n"
       "  mov.b32 f, {0,%1};\n"
...
__CUDA_HOSTDEVICE_BF16_DECL__ __nv_bfloat16 __short2bfloat16_rn(short int i)
{
    float f = static_cast<float>(i);
    return __float2bfloat16_rn(f);
}
__CUDA_BF16_DECL__ __nv_bfloat16 __short2bfloat16_rz(short int i)
{
    return __float2bfloat16_rz(__int2float_rz(static_cast<int>(i)));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __short2bfloat16_rd(short int i)
{
    return __float2bfloat16_rd(__int2float_rd(static_cast<int>(i)));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __short2bfloat16_ru(short int i)
{
    return __float2bfloat16_ru(__int2float_ru(static_cast<int>(i)));
}

__CUDA_BF16_DECL__ unsigned int __bfloat162uint_rn(__nv_bfloat16 h)
{
    return __float2uint_rn(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ unsigned int __bfloat162uint_rz(__nv_bfloat16 h)
{
    const float f = __bfloat162float(h);
    unsigned int i;
...
__CUDA_BF16_DECL__ unsigned int __bfloat162uint_rd(__nv_bfloat16 h)
{
    return __float2uint_rd(__bfloat162float(h));
}
__CUDA_BF16_DECL__ unsigned int __bfloat162uint_ru(__nv_bfloat16 h)
{
    return __float2uint_ru(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ __nv_bfloat16 __uint2bfloat16_rn(unsigned int i)
{
#if (defined __CUDA_ARCH__)
    float ru = __uint2float_ru(i);
    float rd = __uint2float_rd(i);
...
__CUDA_BF16_DECL__ __nv_bfloat16 __uint2bfloat16_rz(unsigned int i)
{
    return __float2bfloat16_rz(__uint2float_rz(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __uint2bfloat16_rd(unsigned int i)
{
    return __float2bfloat16_rd(__uint2float_rd(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __uint2bfloat16_ru(unsigned int i)
{
    return __float2bfloat16_ru(__uint2float_ru(i));
}

__CUDA_BF16_DECL__ unsigned short int __bfloat162ushort_rn(__nv_bfloat16 h)
{
...
__CUDA_HOSTDEVICE_BF16_DECL__ unsigned short int __bfloat162ushort_rz(__nv_bfloat16 h)
{
   unsigned short int val;
#if (defined __CUDA_ARCH__)
   asm("{ .reg.f32 f;\n"
...
__CUDA_BF16_DECL__ unsigned short int __bfloat162ushort_rd(__nv_bfloat16 h)
{
   unsigned short int val;
   asm("{ .reg.f32 f;\n"
       "  mov.b32 f, {0,%1};\n"
...
__CUDA_BF16_DECL__ unsigned short int __bfloat162ushort_ru(__nv_bfloat16 h)
{
   unsigned short int val;
   asm("{ .reg.f32 f;\n"
       "  mov.b32 f, {0,%1};\n"
...
__CUDA_HOSTDEVICE_BF16_DECL__ __nv_bfloat16 __ushort2bfloat16_rn(unsigned short int i)
{
    float f = static_cast<float>(i);
    return __float2bfloat16_rn(f);
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ushort2bfloat16_rz(unsigned short int i)
{
    return __float2bfloat16_rz(__uint2float_rz(static_cast<unsigned int>(i)));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ushort2bfloat16_rd(unsigned short int i)
{
    return __float2bfloat16_rd(__uint2float_rd(static_cast<unsigned int>(i)));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ushort2bfloat16_ru(unsigned short int i)
{
    return __float2bfloat16_ru(__uint2float_ru(static_cast<unsigned int>(i)));
}

__CUDA_BF16_DECL__ unsigned long long int __bfloat162ull_rn(__nv_bfloat16 h)
{
    return __float2ull_rn(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ unsigned long long int __bfloat162ull_rz(__nv_bfloat16 h)
{
    const float f = __bfloat162float(h);
...
__CUDA_BF16_DECL__ unsigned long long int __bfloat162ull_rd(__nv_bfloat16 h)
{
    return __float2ull_rd(__bfloat162float(h));
}
__CUDA_BF16_DECL__ unsigned long long int __bfloat162ull_ru(__nv_bfloat16 h)
{
    return __float2ull_ru(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ __nv_bfloat16 __ull2bfloat16_rn(unsigned long long int i)
{
#if (defined __CUDA_ARCH__)
    float ru = __ull2float_ru(i);
    float rd = __ull2float_rd(i);
...
#else
    float f = static_cast<float>(i);
    unsigned long long int uf = static_cast<unsigned long long int>(f);
    unsigned int u;
...
__CUDA_BF16_DECL__ __nv_bfloat16 __ull2bfloat16_rz(unsigned long long int i)
{
    return __float2bfloat16_rz(__ull2float_rz(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ull2bfloat16_rd(unsigned long long int i)
{
    return __float2bfloat16_rd(__ull2float_rd(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ull2bfloat16_ru(unsigned long long int i)
{
    return __float2bfloat16_ru(__ull2float_ru(i));
}
__CUDA_BF16_DECL__ long long int __bfloat162ll_rn(__nv_bfloat16 h)
{
    return __float2ll_rn(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ long long int __bfloat162ll_rz(__nv_bfloat16 h)
{
    const float f = __bfloat162float(h);
    long long int i;
...
__CUDA_BF16_DECL__ long long int __bfloat162ll_rd(__nv_bfloat16 h)
{
    return __float2ll_rd(__bfloat162float(h));
}
__CUDA_BF16_DECL__ long long int __bfloat162ll_ru(__nv_bfloat16 h)
{
    return __float2ll_ru(__bfloat162float(h));
}
__CUDA_HOSTDEVICE_BF16_DECL__ __nv_bfloat16 __ll2bfloat16_rn(long long int i)
{
#if (defined __CUDA_ARCH__)
    float ru = __ll2float_ru(i);
    float rd = __ll2float_rd(i);
...
#else
    float f = static_cast<float>(i);
    long long int lf = static_cast<long long int>(f);
    unsigned int u;
...
__CUDA_BF16_DECL__ __nv_bfloat16 __ll2bfloat16_rz(long long int i)
{
    return __float2bfloat16_rz(__ll2float_rz(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ll2bfloat16_rd(long long int i)
{
    return __float2bfloat16_rd(__ll2float_rd(i));
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ll2bfloat16_ru(long long int i)
{
...
{
    __nv_bfloat16 low = __float2bfloat16_rz(truncf(__low2float(h)));
    __nv_bfloat16 high = __float2bfloat16_rz(truncf(__high2float(h)));
    return __nv_bfloat162(low, high);
}
__CUDA_BF16_DECL__ __nv_bfloat162 h2ceil(const __nv_bfloat162 h)
{
    __nv_bfloat16 low = __float2bfloat16_ru(ceilf(__low2float(h)));
    __nv_bfloat16 high = __float2bfloat16_ru(ceilf(__high2float(h)));
    return __nv_bfloat162(low, high);
}
__CUDA_BF16_DECL__ __nv_bfloat162 h2floor(const __nv_bfloat162 h)
{
    __nv_bfloat16 low = __float2bfloat16_rd(floorf(__low2float(h)));
    __nv_bfloat16 high = __float2bfloat16_rd(floorf(__high2float(h)));
    return __nv_bfloat162(low, high);
}
...
__CUDA_BF16_DECL__ __nv_bfloat162 __lows2bfloat162(const __nv_bfloat162 l, const __nv_bfloat162 h)
{
    __nv_bfloat162 val;
    asm("{.reg .b16 alow,ahigh,blow,bhigh;\n"
        "  mov.b32 {alow,ahigh}, %1;\n"
        "  mov.b32 {blow,bhigh}, %2;\n"
        "  mov.b32 %0, {alow,blow};}\n" : "=r"(__BFLOAT162_TO_UI(val)) : "r"(__BFLOAT162_TO_CUI(l)), "r"(__BFLOAT162_TO_CUI(h)));
    return val;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __highs2bfloat162(const __nv_bfloat162 l, const __nv_bfloat162 h)
{
    __nv_bfloat162 val;
    asm("{.reg .b16 alow,ahigh,blow,bhigh;\n"
        "  mov.b32 {alow,ahigh}, %1;\n"
...
__CUDA_BF16_DECL__ __nv_bfloat16 __low2bfloat16(const __nv_bfloat162 h)
{
    __nv_bfloat16 ret;
    asm("{.reg .b16 low,high;\n"
        " mov.b32 {low,high}, %1;\n"
        " mov.b16 %0, low;}" : "=h"(__BFLOAT16_TO_US(ret)) : "r"(__BFLOAT162_TO_CUI(h)));
    return ret;
}
__CUDA_BF16_DECL__ int __hisinf(const __nv_bfloat16 a)
{
    ...
    if (__BFLOAT16_TO_CUS(a) == 0x7F80U) {
        return 1;
    }
    return 0;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __low2bfloat162(const __nv_bfloat162 l)
{
    __nv_bfloat162 val;
    asm("{.reg .b16 low,high;\n"
        "  mov.b32 {low,high}, %1;\n"
        "  mov.b32 %0, {low,low};}\n" : "=r"(__BFLOAT162_TO_UI(val)) : "r"(__BFLOAT162_TO_CUI(l)));
    return val;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __high2bfloat162(const __nv_bfloat162 l)
{
    __nv_bfloat162 val;
    asm("{.reg .b16 low,high;\n"
        "  mov.b32 {low,high}, %1;\n"
...
__CUDA_BF16_DECL__ __nv_bfloat16 __high2bfloat16(const __nv_bfloat162 h)
{
    __nv_bfloat16 ret;
    asm("{.reg .b16 low,high;\n"
        " mov.b32 {low,high}, %1;\n"
        " mov.b16 %0, high;}" : "=h"(__BFLOAT16_TO_US(ret)) : "r"(__BFLOAT162_TO_CUI(h)));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __halves2bfloat162(const __nv_bfloat16 l, const __nv_bfloat16 h)
{
    __nv_bfloat162 val;
    asm("{  mov.b32 %0, {%1,%2};}\n"
        : "=r"(__BFLOAT162_TO_UI(val)) : "h"(__BFLOAT16_TO_CUS(l)), "h"(__BFLOAT16_TO_CUS(h)));
    return val;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __bfloat162bfloat162(const __nv_bfloat16 lh)
{
    __nv_bfloat162 val;
    asm("{  mov.b32 %0, {%1,%1};}\n"
        : "=r"(__BFLOAT162_TO_UI(val)) : "h"(__BFLOAT16_TO_CUS(lh)));
    return val;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __lowhigh2highlow(const __nv_bfloat162 lh)
{
    __nv_bfloat162 val;
    asm("{.reg .b16 low,high;\n"
        "  mov.b32 {low,high}, %1;\n"
        "  mov.b32 %0, {high,low};}\n" : "=r"(__BFLOAT162_TO_UI(val)) : "r"(__BFLOAT162_TO_CUI(lh)));
    return val;
}
...
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_sync(unsigned mask, __nv_bfloat162 var, int delta, int width)
{
    int warpSize;
...
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_up_sync(unsigned mask, __nv_bfloat162 var, unsigned int delta, int width)
{
    int warpSize;
    asm("{mov.u32 %0, WARP_SZ;\n}" : "=r"(warpSize));
...
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_down_sync(unsigned mask, __nv_bfloat162 var, unsigned int delta, int width)
{
    int warpSize;
    asm("{mov.u32 %0, WARP_SZ;\n}" : "=r"(warpSize));
    int c = ((warpSize - width) << 8) | 0x1f;
...
__CUDA_BF16_DECL__ __nv_bfloat162 __shfl_xor_sync(unsigned mask, __nv_bfloat162 var, int delta, int width)
{
    int warpSize;
    asm("{mov.u32 %0, WARP_SZ;\n}" : "=r"(warpSize));
    int c = ((warpSize - width) << 8) | 0x1f;
...
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_sync(unsigned mask, __nv_bfloat16 var, int delta, int width)
{
    __nv_bfloat162 temp1 = __halves2bfloat162(var, var);
    __nv_bfloat162 temp2 = __shfl_sync(mask, temp1, delta, width);
    return __low2bfloat16(temp2);
}
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_up_sync(unsigned mask, __nv_bfloat16 var, unsigned int delta, int width)
{
    __nv_bfloat162 temp1 = __halves2bfloat162(var, var);
    __nv_bfloat162 temp2 = __shfl_up_sync(mask, temp1, delta, width);
    return __low2bfloat16(temp2);
}
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_down_sync(unsigned mask, __nv_bfloat16 var, unsigned int delta, int width)
{
    __nv_bfloat162 temp1 = __halves2bfloat162(var, var);
    __nv_bfloat162 temp2 = __shfl_down_sync(mask, temp1, delta, width);
    return __low2bfloat16(temp2);
}
__CUDA_BF16_DECL__ __nv_bfloat16 __shfl_xor_sync(unsigned mask, __nv_bfloat16 var, int delta, int width)
{
    __nv_bfloat162 temp1 = __halves2bfloat162(var, var);
    __nv_bfloat162 temp2 = __shfl_xor_sync(mask, temp1, delta, width);
    return __low2bfloat16(temp2);
}
...
__CUDA_BF16_DECL__ __nv_bfloat162 __ldg(const  __nv_bfloat162 *ptr)
{
    __nv_bfloat162 ret;
    asm ("ld.global.nc.b32 %0, [%1];"  : "=r"(__BFLOAT162_TO_UI(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ldg(const __nv_bfloat16 *ptr)
{
    __nv_bfloat16 ret;
    asm ("ld.global.nc.b16 %0, [%1];"  : "=h"(__BFLOAT16_TO_US(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __ldcg(const  __nv_bfloat162 *ptr)
{
    __nv_bfloat162 ret;
    asm ("ld.global.cg.b32 %0, [%1];"  : "=r"(__BFLOAT162_TO_UI(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ldcg(const __nv_bfloat16 *ptr)
{
    __nv_bfloat16 ret;
    asm ("ld.global.cg.b16 %0, [%1];"  : "=h"(__BFLOAT16_TO_US(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __ldca(const  __nv_bfloat162 *ptr)
{
    __nv_bfloat162 ret;
    asm ("ld.global.ca.b32 %0, [%1];"  : "=r"(__BFLOAT162_TO_UI(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ldca(const __nv_bfloat16 *ptr)
{
    __nv_bfloat16 ret;
    asm ("ld.global.ca.b16 %0, [%1];"  : "=h"(__BFLOAT16_TO_US(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __ldcs(const  __nv_bfloat162 *ptr)
{
    __nv_bfloat162 ret;
    asm ("ld.global.cs.b32 %0, [%1];"  : "=r"(__BFLOAT162_TO_UI(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ldcs(const __nv_bfloat16 *ptr)
{
    __nv_bfloat16 ret;
    asm ("ld.global.cs.b16 %0, [%1];"  : "=h"(__BFLOAT16_TO_US(ret)) : __LDG_PTR(ptr));
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __ldlu(const  __nv_bfloat162 *ptr)
{
    __nv_bfloat162 ret;
    asm ("ld.global.lu.b32 %0, [%1];"  : "=r"(__BFLOAT162_TO_UI(ret)) : __LDG_PTR(ptr) : "memory");
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ldlu(const __nv_bfloat16 *ptr)
{
    __nv_bfloat16 ret;
    asm ("ld.global.lu.b16 %0, [%1];"  : "=h"(__BFLOAT16_TO_US(ret)) : __LDG_PTR(ptr) : "memory");
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat162 __ldcv(const  __nv_bfloat162 *ptr)
{
    __nv_bfloat162 ret;
    asm ("ld.global.cv.b32 %0, [%1];"  : "=r"(__BFLOAT162_TO_UI(ret)) : __LDG_PTR(ptr) : "memory");
    return ret;
}
__CUDA_BF16_DECL__ __nv_bfloat16 __ldcv(const __nv_bfloat16 *ptr)
{
    __nv_bfloat16 ret;
...
__CUDA_BF16_DECL__ void __stwb(__nv_bfloat162 *ptr, __nv_bfloat162 value)
{
    asm ("st.global.wb.b32 [%0], %1;"  :: __LDG_PTR(ptr), "r"(__BFLOAT162_TO_CUI(value)) : "memory");
}
__CUDA_BF16_DECL__ void __stwb(__nv_bfloat16 *ptr, __nv_bfloat16 value)
{
    asm ("st.global.wb.b16 [%0], %1;"  :: __LDG_PTR(ptr),  "h"(__BFLOAT16_TO_CUS(value)) : "memory");
}
__CUDA_BF16_DECL__ void __stcg(__nv_bfloat162 *ptr, __nv_bfloat162 value)
{
    asm ("st.global.cg.b32 [%0], %1;"  :: __LDG_PTR(ptr), "r"(__BFLOAT162_TO_CUI(value)) : "memory");
}
__CUDA_BF16_DECL__ void __stcg(__nv_bfloat16 *ptr, __nv_bfloat16 value)
{
    asm ("st.global.cg.b16 [%0], %1;"  :: __LDG_PTR(ptr),  "h"(__BFLOAT16_TO_CUS(value)) : "memory");
}
__CUDA_BF16_DECL__ void __stcs(__nv_bfloat162 *ptr, __nv_bfloat162 value)
{
    asm ("st.global.cs.b32 [%0], %1;"  :: __LDG_PTR(ptr), "r"(__BFLOAT162_TO_CUI(value)) : "memory");
}
__CUDA_BF16_DECL__ void __stcs(__nv_bfloat16 *ptr, __nv_bfloat16 value)
{
    asm ("st.global.cs.b16 [%0], %1;"  :: __LDG_PTR(ptr),  "h"(__BFLOAT16_TO_CUS(value)) : "memory");
}
__CUDA_BF16_DECL__ void __stwt(__nv_bfloat162 *ptr, __nv_bfloat162 value)
{
    asm ("st.global.wt.b32 [%0], %1;"  :: __LDG_PTR(ptr), "r"(__BFLOAT162_TO_CUI(value)) : "memory");
}
__CUDA_BF16_DECL__ void __stwt(__nv_bfloat16 *ptr, __nv_bfloat16 value)
{
...
#define __COMPARISON_OP_BFLOAT162_MACRO(name) /* do */ {\
   ...
   asm( "{.reg .b32 low_a,low_b,high_a,high_b,high_res,low_res;\n"\
        "  and.b32 high_a, %1, 0xffff0000;\n"\
        "  and.b32 high_b, %2, 0xffff0000;\n"\
        "  shl.b32 low_a, %1, 16;\n"\
        "  shl.b32 low_b, %2, 16;\n"\
...
__CUDA_BF16_DECL__ __nv_bfloat162 __h2div(__nv_bfloat162 a, __nv_bfloat162 b) {
    __nv_bfloat16 ha, hb;

    ha = __low2bfloat16(a);
    hb = __low2bfloat16(b);

    __nv_bfloat16 v1 = __hdiv(ha, hb);

    ha = __high2bfloat16(a);
    hb = __high2bfloat16(b);

    __nv_bfloat16 v2 = __hdiv(ha, hb);
...
__CUDA_BF16_DECL__ __nv_bfloat16 __hdiv(__nv_bfloat16 a, __nv_bfloat16 b) {
...
__CUDA_BF16_DECL__ __nv_bfloat162 h2sin(const __nv_bfloat162 a) {
    __nv_bfloat16 l = __low2bfloat16(a);
    __nv_bfloat16 h = __high2bfloat16(a);
...
__CUDA_BF16_DECL__ __nv_bfloat16 hexp10(const __nv_bfloat16 a) {
    ...
    asm("{.reg.b16         h, r;           \n"
        ...
        " .reg.pred        p;              \n"
        "  mov.b16         h, %1;          \n"
        "  setp.eq.b16     p, h, 0XBC95;   \n"
        "  mov.b32         f, {0,h};       \n"
        "  mov.b32         C, 0x40549A78;  \n"
        "  mul.f32         f,f,C;          \n"
        "  ex2.approx.f32      f, f;       \n"
        "  cvt.rn.bf16.f32    r, f;       \n"
        "  selp.b16        r, 0X3F75, r, p;\n"
        "  mov.b16         %0, r;          \n"
        "}":"=h"(__BFLOAT16_TO_US(val)) : "h"(__BFLOAT16_TO_CUS(a)));
    return val;
}
__CUDA_BF16_DECL__ __nv_bfloat162 h2exp10(const __nv_bfloat162 a) {
    ...
    asm("{.reg.b16         hl, hu;         \n"
        ...
        " .reg.pred        pl, pu;         \n"
        "  mov.b32         {hl, hu}, %1;   \n"
        "  setp.eq.b16     pl, hl, 0XBC95; \n"
        "  setp.eq.b16     pu, hu, 0XBC95; \n"
        "  mov.b32         fl, {0,hl};     \n"
        "  mov.b32         fu, {0,hu};     \n"
        "  mov.b32         C, 0x40549A78;  \n"
        "  mul.f32         fl,fl,C;        \n"
        ...
        "  cvt.rn.bf16.f32    hl, fl;     \n"
        "  cvt.rn.bf16.f32    hu, fu;     \n"
        "  selp.b16        hl,0X3F75,hl,pl;\n"
        "  selp.b16        hu,0X3F75,hu,pu;\n"
        "  mov.b32         r, {hl, hu};    \n"
        "  mov.b32         %0, r;  \n"
        "}":"=r"(__BFLOAT162_TO_UI(val)) : "r"(__BFLOAT162_TO_CUI(a)));
    return val;
...
__CUDA_BF16_DECL__ __nv_bfloat162 atomicAdd(__nv_bfloat162 *address, __nv_bfloat162 val)
{
...
__CUDA_BF16_DECL__ __nv_bfloat16 atomicAdd(__nv_bfloat16 *address, __nv_bfloat16 val)
{
